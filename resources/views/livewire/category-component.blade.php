                    ...
                    <div class="col-lg-9">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p> We found <strong class="text-brand">{{$annonces->total()}}</strong> items for you from<strong class="text-brand"> {{$category_name}} </strong> Category!</p>
                            </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                    <div class="product-cart-wrap mb-30">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="{{route('product.details',['slug'=>$annonce->product->slug,'id'=>$annonce->id])}}">
                                                    <img class="default-img" src="{{--{{asset('assets/imgs/shop/product-')}}{{$annonce->product->id}}-1.jpg--}}{{ asset('storage/'.$annonce->product->image->first()->imageName)}}" alt="{{$annonce->product->title}}">
                                                    <img class="hover-img" src="{{--{{asset('assets/imgs/shop/product-')}}{{$annonce->product->id}}-2.jpg--}}{{ asset('storage/'.$annonce->product->image->first()->imageName)}}" alt="{{$annonce->product->title}}">
                                                </a>
                                            </div>
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            {{-- <div class="product-action-1 show">
                                                <a aria-label="Add To Cart" class="action-btn hover-up" href="#" wire:click.prevent="store({{$annonce->id}},'{{$annonce->product->title}}' , {{$annonce->regular_price}})"><i class="fi-rs-shopping-bag-add"></i></a>
                                            </div> --}}
                                        </div>
                                    </div>
                                </div>
